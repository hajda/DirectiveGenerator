...
public class DirectiveGenerator {
    ...
    public void generateDirective(final String myModule, final String pfx, final String myDirective, final String nested) {
        ...
        try {
            ...
            writer.println("        }));");
            writer.println("        beforeEach(inject(function injectDependencies(_$compile_, $rootScope, _" + Pfx + MyDirective + "_) {");
            writer.println("            $compile = _$compile_;");
            writer.println("            $scope = $rootScope.$new();");
            writer.println("            " + MyDirective  + " = _" + Pfx + MyDirective + "_;");
            writer.println("        }));");
            writer.println("");
            ...
            writer.println("            mockDependencies($provide);");
            writer.println("        }));");
            writer.println("        beforeEach(inject(function injectDependencies(_$controller_, $rootScope, _" + Pfx + MyDirective + "_) {");
            writer.println("            $scope = $rootScope.$new();");
            writer.println("            $controller = _$controller_;");
            ...
            writer.println("            mockDependencies($provide);");
            writer.println("        }));");
            writer.println("        beforeEach(inject(function injectDependencies(_" + Pfx + MyDirective + "_) {");
            writer.println("            " + MyDirective  + " = _" + Pfx + MyDirective + "_;");
            writer.println("        }));");
            writer.println("");
            writer.println("        it('should ...', function spec() {");
